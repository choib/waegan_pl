...
def process_mteg(img_dir, output_dir):
    #save_phase = 'test' if phase == 'val' else 'train'
    #savedir = os.path.join(output_dir, save_phase)
    savedir = os.path.join(output_dir)
    ...
    photo_expr = os.path.join(img_dir) + "/*.jpg"
...
if __name__ == '__main__':
    ...
    print('Preparing MTEG Dataset for photo')
    process_mteg(opt.img_dir, opt.output_dir)
