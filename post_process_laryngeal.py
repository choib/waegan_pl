...
#     [(180, 255, 255)],
#     [(180, 225, 225)]]
low_hsv = [[(0, 100, 100), (175, 100, 100)],  # BT(red)
           [(145, 100, 100)],  # LC(pink)
           [(0, 50, 50)],  # _full
           [(0, 50, 50)]]  # _uncertaim
high_hsv = [[(5, 255, 255), (180, 255, 255)],  # BT(red)
            [(155, 255, 255)],  # LC(pink)
            [(180, 255, 255)],  # _full
...
def main():
    ...
    parser.add_argument('--inp', help='Input file path',default="/home/mteg-vas/nisan/workspace/wgan_git/data/larangeal/testB/UH0001_CD18_AAAA0016_Laryn_BT_000001_0003.png", type=str)
    # parser.add_argument('--inp', help='Input file path',default="/home/mteg-vas/nisan/workspace/wgan_git/data/larangeal/testB/UH0001_CD18_AAAA0016_Laryn_LC_000009_0002.png", type=str)
    # parser.add_argument('--inp', help='Input file path',default="/home/mteg-vas/nisan/workspace/wgan_git/data/larangeal/testB/UH0001_CD18_AAAA0016_Laryn_NO_000020_0008.png", type=str)
    ...
    parser.add_argument("--val_target", dest="val_target", default='test', choices=['train', 'test', 'user', 'update'],
                        type=str, help="target dataset to validation")
    ...
    max_index, uncertainty, full_area, full_cnt = critic_segmentation(img_org)
    ...
    if full_area > 1e-3:
        ...
        print("uncertainty: {}\tclass: {}\t{}".format( uncertainty, key, max_index))
